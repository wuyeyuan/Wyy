...
# 结果可视化
# 创建日期范围
date_range = pd.date_range(start='2022-4-11', end='2023-4-1', freq='D')
...
# 绘制数据
ax.plot(date_range, y_test, color='blue', label='ground truth')
ax.plot(date_range, y_pred, color='red', label='predictions')
...
for i in range(1, 7): # range(x,y) =y-x 个
...
# 保存工作簿
#wb.save("/Users/yuanyuan/Desktop/ictisBS/y_hat/y_hat205.xlsx")
